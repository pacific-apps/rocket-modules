...
try {
    ...
    if (!empty($restriction)) {
        ...
        if ($restriction[0]['toExpireAt'] > TimeStamp::now()) {
            throw new ResourceAccessForbiddenException(
                'Unable to request to change email address at the moment, email address has been updated recently'
            );
        }
    ...
    $query->prepare([
        ...
        ':createdBy' => 'users/email/request',
        ':createdFor' => 'user_email_update',
